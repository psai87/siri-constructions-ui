...
export default function AboutPage() {
    return (
        <div className="min-h-screen bg-gray-100 text-gray-900 p-4 md:p-12">
            {/* Hero Section Card */}
            ...
            <section className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 md:p-12 max-w-6xl mx-auto my-6 md:my-8">
                <div>
                    <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-blue-700">Our Services</h2>
            ...
            <section className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 md:p-12 max-w-6xl mx-auto my-6 md:my-8">
                <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-blue-700">Our Product Offerings</h2>
            ...
            <section className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 md:p-12 max-w-6xl mx-auto my-6 md:my-8">
                <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-blue-700">Company Overview</h2>
                <ul className="list-disc pl-6 space-y-3 text-base sm:text-lg text-gray-700">
                    <li><strong className="text-gray-900">Established:</strong> 1992</li>
                    <li><strong className="text-gray-900">Business Type:</strong> Proprietary</li>
                    <li><strong className="text-gray-900">Proprietor:</strong> Mr. S. Venkateswara Rao</li>
                    <li><strong className="text-gray-900">Headquarters:</strong> Visakhapatnam, Andhra Pradesh</li>
                    <li><strong className="text-gray-900">Team Strength:</strong>
            ...
            {/* Expertise & Core Competencies Card */}
            <section className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 md:p-12 max-w-6xl mx-auto my-6 md:my-8">
                <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-blue-700">Expertise & Core Competencies</h2>
                <p className="text-base sm:text-lg mb-6 leading-relaxed text-gray-700">
